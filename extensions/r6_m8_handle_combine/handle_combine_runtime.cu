// R6-M8: revealed-only DescriptorCommit scheduler -> fused token-centric
...
struct Runtime {
  ...
  Runtime(int rank_, int device_, const ncclUniqueId* unique_id,
    ...
    requirements.lsaBarrierCount = layout.max_descriptors + 1;
  ...
  void run(const int64_t* reveal_records, uint32_t record_count,
    ...
    progressive_combine_kernel<<<1, 256, 0, pipeline_stream>>>(
        ...
        registered_buffer, layout.max_descriptors, d_return_traces,
        max_recv_records, d_return_trace_count, d_combine_counters);
    progressive_combine_wait_kernel<<<1, 256, 0, pipeline_stream>>>(
        dev_comm, layout.max_descriptors, d_combine_completion_time,
        d_combine_counters);
...
using namespace rlccl::ep::m8_runtime;

extern "C" {

const char* r6_m8_last_error() { return last_error.c_str(); }
size_t r6_m8_unique_id_size() { return sizeof(ncclUniqueId); }

int r6_m8_get_unique_id(void* output, size_t bytes) {
  return protect([&] {
...
uint64_t r6_m8_combine_counter(void* opaque, int index) {
...
uint64_t r6_m8_counter(void* opaque, int index) {
...
uint64_t r6_m8_capability(void* opaque, int index) {
...
size_t r6_m8_commit_count(void* opaque) { return static_cast<Runtime*>(opaque)->commits.size(); }
size_t r6_m8_peer_plan_count(void* opaque) { return static_cast<Runtime*>(opaque)->peer_plans.size(); }
size_t r6_m8_shadow_action_count(void* opaque) { return static_cast<Runtime*>(opaque)->shadow_actions.size(); }
size_t r6_m8_trace_count(void* opaque) { return static_cast<Runtime*>(opaque)->traces.size(); }
size_t r6_m8_timing_count(void* opaque) { return static_cast<Runtime*>(opaque)->timings.size(); }
size_t r6_m8_num_recv_tokens(void* opaque) { return static_cast<Runtime*>(opaque)->handle.num_recv_tokens; }
size_t r6_m8_num_local_experts(void* opaque) { return static_cast<Runtime*>(opaque)->num_local_experts; }
size_t r6_m8_return_trace_count(void* opaque) { return static_cast<Runtime*>(opaque)->return_traces.size(); }
size_t r6_m8_num_source_tokens(void* opaque) { return static_cast<Runtime*>(opaque)->combine_layout.num_source_tokens; }

int r6_m8_copy_commits(void* opaque, uint64_t* output, size_t rows) {
  return protect([&] {
...
int r6_m8_copy_peer_plans(void* opaque, uint64_t* output, size_t rows) {
  return protect([&] {
    const auto* runtime = static_cast<Runtime*>(opaque);
...
int r6_m8_copy_shadow_actions(void* opaque, int64_t* output, size_t rows) {
  return protect([&] {
...
int r6_m8_copy_traces(void* opaque, uint64_t* output, size_t rows) {
  return protect([&] {
...
int r6_m8_copy_timings(void* opaque, uint64_t* output, size_t rows) {
  return protect([&] {
...
int r6_m8_copy_expert_counts(void* opaque, uint32_t* output, size_t values) {
  return protect([&] {
...
int r6_m8_copy_expert_offsets(void* opaque, uint32_t* output, size_t values) {
  return protect([&] {
...
int r6_m8_copy_recv_x(void* opaque, float* output, size_t elements) {
  return protect([&] {
    const auto* runtime = static_cast<Runtime*>(opaque);
...
int r6_m8_copy_recv_metadata(void* opaque, void* output, size_t rows) {
  return protect([&] {
    const auto* runtime = static_cast<Runtime*>(opaque);
...
int r6_m8_copy_return_traces(void* opaque, uint64_t* output, size_t rows) {
  return protect([&] {
...
int r6_m8_copy_final_output(void* opaque, float* output, size_t elements) {
  return protect([&] {
...
void r6_m8_destroy(void* opaque) { delete static_cast<Runtime*>(opaque); }
